...
/**
  ...
  * @param itemId          Identifies the assignment item. The first element of the pair identifies the premium version of
  *                        the assignment, and the second element the non-premium version.
