...
class ExtractionTest extends FunSuite with BeforeAndAfterAll {
  ...
  test("localizedObsrvations") {
    ...
    val observations = sc.parallelize(List(
      Observation(stn = "010013", wban = None,          month = 11, day = 25, temperature =  +4.0),
      Observation(stn = "724017", wban = None,          month =  8, day = 11, temperature = +27.3),
      Observation(stn = "724017", wban = Some("03707"), month = 12, day =  6, temperature =  +0.0),
      Observation(stn = "724017", wban = Some("03707"), month =  1, day = 29, temperature =  +2.0)
    ))
    ...
    assert(actual == Set(
      (
        Observation("724017", Some("03707"), 12, 6, +0.0),
        Station("724017", Some("03707"), +37.358, -078.438)
      ),
      (
        Observation("724017", Some("03707"), 1, 29, +2.0),
        Station("724017", Some("03707"), +37.358, -078.438)
      ),
      (
